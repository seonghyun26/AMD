...
export function PillTabs({
  ...
  return (
    <div className="flex items-center gap-1 p-2 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 overflow-x-auto">
      {TABS.map(({ value, label, icon }) => (
        <button
          ...
          className={`flex flex-shrink-0 items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap transition-all ${
            active === value
              ? "bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-500 text-white shadow-md shadow-blue-500/20"
